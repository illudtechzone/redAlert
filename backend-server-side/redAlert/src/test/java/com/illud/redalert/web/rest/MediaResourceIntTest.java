...
public class MediaResourceIntTest {
    ...
    public void createMedia() throws Exception {
        ...
        assertThat(testMedia.getAttachment()).isEqualTo(DEFAULT_ATTACHMENT);
        assertThat(testMedia.getAttachmentContentType()).isEqualTo(DEFAULT_ATTACHMENT_CONTENT_TYPE);
    }
    ...
    public void updateMedia() throws Exception {
        ...
        Media testMedia = mediaList.get(mediaList.size() - 1);
        assertThat(testMedia.getAttachment()).isEqualTo(UPDATED_ATTACHMENT);
        assertThat(testMedia.getAttachmentContentType()).isEqualTo(UPDATED_ATTACHMENT_CONTENT_TYPE);
    }

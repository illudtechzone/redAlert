...
public class FriendServiceImpl implements FriendService {
     ...
     * @return the list of entities
     */
    public Page<FriendDTO> findAllWithEagerRelationships(Pageable pageable) {
        return friendRepository.findAllWithEagerRelationships(pageable).map(friendMapper::toDto);
    }
    ...
    public Optional<FriendDTO> findOne(Long id) {
        ...
        return friendRepository.findOneWithEagerRelationships(id)
            .map(friendMapper::toDto);
    }

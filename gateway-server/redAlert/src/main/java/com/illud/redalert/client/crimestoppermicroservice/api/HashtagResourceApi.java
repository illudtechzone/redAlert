...
public interface HashtagResourceApi {
    ...
    @ApiOperation(value = "trendingHashtags", nickname = "trendingHashtagsUsingGET", notes = "", response = HashtagDTO.class, responseContainer = "List", tags={ "hashtag-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = HashtagDTO.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
    ...
    @RequestMapping(value = "/api/trending/hashtags",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<List<HashtagDTO>> trendingHashtagsUsingGET();

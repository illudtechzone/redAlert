...
public interface UserResponseResourceApi {
    ...
    @ApiOperation(value = "addUserResponseOfComment", nickname = "addUserResponseOfCommentUsingPOST", notes = "", response = UserResponseDTO.class, tags={ "user-response-resource", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/api/comment/user-response",
        produces = "*/*", 
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<UserResponseDTO> addUserResponseOfCommentUsingPOST(@ApiParam(value = "userResponse" ,required=true )  @Valid @RequestBody UserResponseDTO userResponseDTO);
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/complaint/user-response",
        produces = "*/*", 
        consumes = "application/json",
        method = RequestMethod.POST)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/comments/{commentId}/user-responses",
        produces = "*/*", 
        method = RequestMethod.GET)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/complaints/{complaintId}/user-responses",
        produces = "*/*", 
        method = RequestMethod.GET)
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/replies/{replyId}/user-responses",
        produces = "*/*", 
        method = RequestMethod.GET)
    ...
    @ApiOperation(value = "test2", nickname = "test2UsingGET", notes = "", tags={ "user-response-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/users/{userId}/complaints/{complaintId}/user_response",
        method = RequestMethod.GET)
    ResponseEntity<Void> test2UsingGET(@ApiParam(value = "complaintId",required=true) @PathVariable("complaintId") Long complaintId,@ApiParam(value = "userId",required=true) @PathVariable("userId") Long userId);

...
import com.illud.redalert.client.redalertmicroservice.model.ReportDTO;
...
public interface ReportResourceApi {
    ...
    @ApiOperation(value = "getAllReportsByPostId", nickname = "getAllReportsByPostIdUsingGET", notes = "", response = ReportDTO.class, responseContainer = "List", tags={ "report-resource", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = ReportDTO.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
        @ApiResponse(code = 404, message = "Not Found") })
    @RequestMapping(value = "/api/reports1/{postId}",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<List<ReportDTO>> getAllReportsByPostIdUsingGET(@ApiParam(value = "postId",required=true) @PathVariable("postId") Long postId,@ApiParam(value = "Page number of the requested page") @Valid @RequestParam(value = "page", required = false) Integer page,@ApiParam(value = "Size of a page") @Valid @RequestParam(value = "size", required = false) Integer size,@ApiParam(value = "Sorting criteria in the format: property(,asc|desc). Default sort order is ascending. Multiple sort criteria are supported.") @Valid @RequestParam(value = "sort", required = false) List<String> sort);
